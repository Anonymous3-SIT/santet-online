...
\033[1;37m     / /     \  \033[1;37m       Made with \033[1;31m<3\033[0m\033[1;37m by Mr.TamfanX\033[0m
\033[1;37m    (_)))_ _," \033[0m
\033[1;37m        ||||        DedSecTL - Cvar1984 - Pem4lang_SEC\033[0m
\033[1;37m       _||||_,      CiKu370  - amsitlab - Mr.TamfanX\033[0m
...
while True:
	try:
		...
		if santet == "01" or santet == "1":
			...
			print("WhatsApp: 08999271792\nInstagram: mrtamfanx\nFacebook: mrtamfanx\nGitHub: Anonymous3-SIT\nGitLab: dtlily\nYoutube: dtlily")
		elif santet.lower() == "about":
			print("Version 1.1\n\nCopyright (C) 2020 by Mr.TamfanX\n\nSIT_GM\nShutdown Indo Team\nPem4lang_SEC\nMr.X\namsitlab\n[M]izuno\n3RROR_TMX\nMr.K3N\nZetSec\nM.C.A\nL_Viole\nX14N23N6\nMR.R45K1N\nlord.zephyrus\n4cliba788\nmr0x100\nMrx04\nViruz\nMr_007\nITermSec\nIdannovita.\nBlackHole Security.")
		...
		print("The phone number is invalid (caused by Mr.TamfanX)")
